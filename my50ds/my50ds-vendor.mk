...
$(LOCAL_PATH)/system/lib/hwcomposer.mt6582.so:system/lib/hwcomposer.mt6582.so \
$(LOCAL_PATH)/system/lib/libEGL.so:system/lib/libEGL.so \
$(LOCAL_PATH)/system/lib/libEGL_mali.so:system/lib/libEGL_mali.so \
$(LOCAL_PATH)/system/lib/libion.so:system/lib/libion.so \
$(LOCAL_PATH)/system/lib/libMali.so:system/lib/libMali.so \
$(LOCAL_PATH)/system/lib/libriltmk.so:system/lib/libriltmk.so \
$(LOCAL_PATH)/system/lib/egl/egl.cfg:system/lib/egl/egl.cfg \
$(LOCAL_PATH)/system/lib/egl/libGLESv1_mali.so:system/lib/egl/libGLESv1_mali.so \
...
$(LOCAL_PATH)/system/lib/hw/audio_policy.deafult.so:system/lib/hw/audio_policy.deafult.so \
